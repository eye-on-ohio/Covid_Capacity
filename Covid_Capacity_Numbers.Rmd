...
Adult_Capacity <- function(Yo.Hospital){Adult_Hospital_Beds_By_Day_and_Facility %>% 
    ...
    geom_line()+
    labs(title=paste(Yo.Hospital,"-Adult Med/Surg beds available"),subtitle=("Mid-March through  Dec. 18"),caption = "Source: Ohio Department of Health; Graph credit: Eye on Ohio, the Ohio Center for Journalism")+
...
Adult_ICU_Capacity <- function(Yo.Hospital){Adult_Hospital_Beds_By_Day_and_Facility %>% 
    ...
    geom_line()+
    labs(title=paste(Yo.Hospital,"-Adult Critical Care beds available"),subtitle=("Mid-March through Dec. 18"),caption = "Source: Ohio Department of Health; Graph credit: Eye on Ohio, the Ohio Center for Journalism")+
  ggsave(Yo.Hospital, plot = last_plot(), device="jpeg")
}
...
Kid_Capacity <- function(Yo.Hospital){Kid_Hospital_Beds_By_Day_and_Facility %>% 
    ...
    ggplot(aes(x=Date, y=`Med/Surg`))+
    geom_line()+
    labs(title=paste(Yo.Hospital,"-Pediatric Med/Surg beds available"),subtitle=("Mid-March through Dec. 18"),caption = "Source: Ohio Department of Health; Graph credit: Eye on Ohio, the Ohio Center for Journalism")+
  ggsave(Yo.Hospital, plot = last_plot(), device="jpeg")
}
...
Kid_ICU_Capacity <- function(Yo.Hospital){Kid_Hospital_Beds_By_Day_and_Facility %>% 
    ...
    ggplot(aes(x=Date, y=`Critical Care`))+
    geom_line()+
    labs(title=paste(Yo.Hospital,"-Pediatric Critical Care beds available"),subtitle=("Mid-March through Dec. 18"),caption = "Source: Ohio Department of Health; Graph credit: Eye on Ohio, the Ohio Center for Journalism")+
  ggsave(Yo.Hospital, plot = last_plot(), device="jpeg")
}
